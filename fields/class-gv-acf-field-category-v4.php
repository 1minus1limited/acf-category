...
class gv_acf_field_category extends acf_field {
	...
	*/
	...
	function __construct( $settings )
	{
		// vars
		$this->name = 'category';
		$this->label = __('Category');
		$this->category = __("Basic",'cat'); // Basic, Content, Choice, etc
		$this->defaults = array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Preview Size",'cat'); ?></label>
		<p class="description"><?php _e("Thumbnail is advised",'cat'); ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'thumbnail' => __('Thumbnail', 'cat'),
				'something_else' => __('Something Else', 'cat'),
			)
		));
